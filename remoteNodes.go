...
const urlLitheRemoteNodes = "https://raw.githubusercontent.com/Lithe-Project/CN-nodes-list/master/lithe-nodes.json"
...
func requestListRemoteNodes() (remoteNodes []node) {
	...
	theNodes := new(nodes)
	err := getJSONFromHTTPRequest(urlLitheRemoteNodes, theNodes)
...
func requestFeeOfNode(theNode node) (feeValue float64, err error) {
	...
	return theNodeFeeInfo.Amount / 100000, nil
}
