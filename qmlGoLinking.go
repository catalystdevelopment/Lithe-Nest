...
type QmlBridge struct {
	...
	_ func(amountLITHE string) string `slot:"getTransferAmountUSD"`
...
func connectQMLToGOFunctions() {
	...
	qmlBridge.ConnectGetTransferAmountUSD(func(amountLITHE string) string {
		return amountStringUSDToLITHE(amountLITHE)
	})
